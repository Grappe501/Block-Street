...
| **Volume 5** | How does the platform connect to the outside world? | [PLATFORM_SERVICES_INTEGRATION_ARCHITECTURE.md](PLATFORM_SERVICES_INTEGRATION_ARCHITECTURE.md) [PSI-001] · [14 steps](../volume-05/VOLUME_5_MASTER_SEQUENCE.md) **complete** |
| **CKK** | How is the Canon made operational? | [CANONICAL_KNOWLEDGE_KERNEL.md](../canon/CANONICAL_KNOWLEDGE_KERNEL.md) [CKK-001] · Stage 1 bootstrap **MVP** |
