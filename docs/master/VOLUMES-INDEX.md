...
| **Volume 5** | How does the platform connect to the outside world? | [PLATFORM_SERVICES_INTEGRATION_ARCHITECTURE.md](PLATFORM_SERVICES_INTEGRATION_ARCHITECTURE.md) [PSI-001] · [14 steps](../volume-05/VOLUME_5_MASTER_SEQUENCE.md) 13/14 |
