#!/usr/bin/env node
/**
 * CAE-11.7-W6 — Communication intelligence validation
 */
...
const code = [
  ...
  "src/lib/civic-action/builds/11.7/w6.ts",
  ...
  "src/app/(site)/communications/intelligence/page.tsx",
];
...
const w6 = reqs.requirements.filter((r) => r.build === "11.7" && r.wave === "W6");
...
const testRun = spawnSync("node", [join(root, "scripts/phase11/invoke-w6-tests-11.7.mjs")], {
  cwd: root,
  stdio: "inherit",
...
console.log("CAE-11.7-W6 Communications Intelligence checks passed");
