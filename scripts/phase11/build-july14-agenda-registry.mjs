...
const registry = {
  ...
  finding: {
    ...
    note: "No pre-existing agenda IDs 04–034 existed in the repository as keyed agenda items. Items 01–34 freeze exact English language from Identity i18n and the July 14 presentation twin without inventing replacement titles or reordering meeting sections. Item 34 also resolves alias 034 for deep links. Content leaves in the requested emphasis band begin at item 04 (Chance and Xay).",
  },
