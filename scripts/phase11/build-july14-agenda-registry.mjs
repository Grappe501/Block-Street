...
const LEAVES = [
  ...
  { n: "02", title: "1. Introductions", body: "Lead with people, not product.", section: "s1", family: "A", duration: 1, slide: "intro", drill: "/presentations/july-14/presenter?item=03", action: "Begin introductions", i18n: "agenda.s1.title" },
  ...
  { n: "05", title: "Quick Name and School: Each participant introduces themselves with their name & school (e.g., “Alex, University of Arkansas”).", body: "Quick Name and School: Each participant introduces themselves with their name & school (e.g., “Alex, University of Arkansas”).", section: "s1", family: "A", duration: 2, slide: "intro", drill: "/command/campus", action: "Find your campus", i18n: "agenda.s1.c" },
  { n: "06", title: "2. Why This Matters", body: "We’re at a perfect political cusp. 2026–2028 can be decided by young voters — if we organize now.", section: "s2", family: "B", duration: 1, slide: "urgency", drill: "/presentations/july-14/explain/why-cusp", action: "Optional: why the cusp", i18n: "agenda.s2.title" },
  { n: "07", title: "We’re at a perfect political cusp. The next elections (2026–2028) have the capability to be decided by young voters. If we organize now, we can influence every seat in the state.", body: "We’re at a perfect political cusp. The next elections (2026–2028) have the capability to be decided by young voters. If we organize now, we can influence every seat in the state.", section: "s2", family: "B", duration: 1, slide: "urgency", drill: "/presentations/july-14/explain/why-cusp", action: "Optional note", i18n: "agenda.s2.urgency.a" },
  { n: "08", title: "Steve (Overall Organizer) has never seen Arkansas colleges organize like this before. This is our chance to make history.", body: "Steve (Overall Organizer) has never seen Arkansas colleges organize like this before. This is our chance to make history.", section: "s2", family: "B", duration: 1, slide: "urgency", drill: "/presentations/july-14/explain/why-colleges", action: "Optional note", i18n: "agenda.s2.urgency.b" },
  { n: "09", title: "You are the most valuable thing to politicians. Young voters are the largest and most untapped voting bloc by large margin. Politicians need us to win, but we need to organize to demand power in return.", body: "You are the most valuable thing to politicians. Young voters are the largest and most untapped voting bloc by large margin. Politicians need us to win, but we need to organize to demand power in return.", section: "s2", family: "B", duration: 1, slide: "urgency", drill: "/presentations/july-14/explain/why-young-voters", action: "Optional note", i18n: "agenda.s2.urgency.c" },
  { n: "10", title: "More than 50% of the voting population is under 50, but the rules are still made by those over 50. We have the numbers but not the organization to aid ourselves, yet.", body: "More than 50% of the voting population is under 50, but the rules are still made by those over 50. We have the numbers but not the organization to aid ourselves, yet.", section: "s2", family: "B", duration: 1, slide: "problem-opportunity", drill: "/presentations/july-14/explain/why-young-voters", action: "Optional note", i18n: "agenda.s2.problem.a" },
  { n: "11", title: "Ballot initiatives and lawmaking are areas where young people can have a massive impact—if we’re united.", body: "Ballot initiatives and lawmaking are areas where young people can have a massive impact—if we’re united.", section: "s2", family: "C", duration: 1, slide: "problem-opportunity", drill: "/presentations/july-14/explain/ballot-power", action: "Optional note", i18n: "agenda.s2.problem.b" },
  { n: "12", title: "Swinging the election for people like Kelly, people like Chris, or whoever we decide has our intentions best in mind. This isn’t about a single candidate. It’s about building team voting power to amplify our voice and demand change.", body: "Swinging the election for people like Kelly, people like Chris, or whoever we decide has our intentions best in mind. This isn’t about a single candidate. It’s about building team voting power to amplify our voice and demand change.", section: "s2", family: "B", duration: 1, slide: "problem-opportunity", drill: "/presentations/july-14/explain/after-election", action: "Optional note", i18n: "agenda.s2.opportunity.a" },
  { n: "13", title: "After the election, we can uplift each other and future leaders to run for office in the coming years.", body: "After the election, we can uplift each other and future leaders to run for office in the coming years.", section: "s2", family: "D", duration: 1, slide: "problem-opportunity", drill: "/presentations/july-14/explain/after-election", action: "Optional note", i18n: "agenda.s2.opportunity.b" },
  { n: "14", title: "Every campus or group will be unique. We’re providing resources and support, but every group will shape this to fit their community.", body: "Every campus or group will be unique. We’re providing resources and support, but every group will shape this to fit their community.", section: "s3", family: "B", duration: 1, slide: "how", drill: "/presentations/july-14/explain/campus-unique", action: "Optional note", i18n: "agenda.s3.approach.body" },
  ...
  { n: "20", title: "Summer is the best time to organize. Life is less chaotic with school out so we can build momentum before the fall rush. Grinding this next month is essential.", body: "Summer is the best time to organize. Life is less chaotic with school out so we can build momentum before the fall rush. Grinding this next month is essential.", section: "s3", family: "A", duration: 1, slide: "why-now", drill: "/presentations/july-14/explain/campus-unique", action: "Optional note", i18n: "agenda.s3.why.body" },
  { n: "21", title: "A social network across the state of young people (16–24) to get engaged, inform their peers, and establish political power.", body: "A social network across the state of young people (16–24) to get engaged, inform their peers, and establish political power.", section: "s4", family: "C", duration: 1, slide: "building", drill: "/presentations/july-14/goals", action: "See goals broken out", i18n: "agenda.s4.vision.a" },
  { n: "22", title: "Making politics fun", body: "Making politics fun", section: "s4", family: "G", duration: 1, slide: "building", drill: "/presentations/july-14/goals", action: "See goals broken out", i18n: "agenda.s4.vision.b" },
  ...
  { n: "24", title: "Set a foundation for organizing young people to run for office in future elections.", body: "Set a foundation for organizing young people to run for office in future elections.", section: "s4", family: "C", duration: 1, slide: "building", drill: "/presentations/july-14/goals", action: "See goals broken out", i18n: "agenda.s4.long.a" },
  { n: "25", title: "Build soft power to influence local politics and politicians.", body: "Build soft power to influence local politics and politicians.", section: "s4", family: "C", duration: 1, slide: "building", drill: "/presentations/july-14/goals", action: "See goals broken out", i18n: "agenda.s4.long.b" },
  { n: "26", title: "Ballot initiatives and lawmaking — areas where we can have massive effect.", body: "Ballot initiatives and lawmaking — areas where we can have massive effect.", section: "s4", family: "C", duration: 1, slide: "building", drill: "/presentations/july-14/goals", action: "See goals broken out", i18n: "agenda.s4.long.c" },
  { n: "27", title: "Create a statewide network that prepares young leaders to take on leadership roles everywhere.", body: "Create a statewide network that prepares young leaders to take on leadership roles everywhere.", section: "s4", family: "D", duration: 1, slide: "building", drill: "/presentations/july-14/goals", action: "See goals broken out", i18n: "agenda.s4.long.d" },
  { n: "28", title: "Build collective power so we can change the government together.", body: "Build collective power so we can change the government together.", section: "s4", family: "B", duration: 1, slide: "building", drill: "/presentations/july-14/goals", action: "See goals broken out", i18n: "agenda.s4.long.e" },
  { n: "29", title: "Walk through the website’s features", body: "Walk through the website’s features", section: "s5", family: "B", duration: 2, slide: "website", drill: "/command", action: "Open command boards", i18n: "agenda.s5.a" },
  { n: "30", title: "Highlight how they can access materials, training, and support to get started", body: "Highlight how they can access materials, training, and support to get started", section: "s5", family: "C", duration: 1, slide: "website", drill: "/command", action: "Open command + jobs", i18n: "agenda.s5.b" },
...
const twin = join(root, "src/lib/presentations/july-14-agenda.json");
mkdirSync(dirname(twin), { recursive: true });
writeFileSync(twin, JSON.stringify(registry, null, 2) + "\n");
console.log(`Wrote ${registry.items.length} items → ${out} (+ twin ${twin}) (${totalDuration} min leaf sum)`);
