#!/usr/bin/env node
/**
 * CAE-11.2-W5 — Objective API, events, and integration validation
 */
...
const code = [
  ...
  "src/lib/civic-action/builds/11.2/w5.ts",
  "src/lib/civic-action/builds/11.2/w5-tests.ts",
  "src/app/api/v1/objectives/route.ts",
  "src/app/api/v1/objectives/commands/route.ts",
...
const w5 = reqs.requirements.filter((r) => r.build === "11.2" && r.wave === "W5");
if (w5.length < 20) fail(`expected 20+ W5 requirements, got ${w5.length}`);

const testRun = spawnSync("node", [join(root, "scripts/phase11/invoke-w5-tests-11.2.mjs")], {
  cwd: root,
  stdio: "inherit",
...
console.log("CAE-11.2-W5 Objective APIs, Events, and Integrations checks passed");
