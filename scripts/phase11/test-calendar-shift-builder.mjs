...
const blocks = cal.generateShiftsFromRequirement({ eventId: event.event_id, requirementId: reqs[0].requirementId, pattern: "setup_program_breakdown" });
assert(blocks.length === 3, "setup program breakdown");
console.log("test:calendar:shift-builder PASS");
