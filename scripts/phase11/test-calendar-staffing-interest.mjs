...
const mine = cal.listMyInterests("usr-demo-001");
assert(mine.length === 1, "my interests");
const pub = JSON.stringify(mine);
assert(!pub.includes("@"), "no email in interest export");
console.log("test:calendar:staffing-interest PASS");
