...
/**
 * @deprecated Flat 25% — superseded by enrollment-share campus formula (V2-A.3).
 */
...
export function getFieldGoalsMeta() {
  return {
    ...
    source_honesty:
      "Numbers come from RedDirt Victory Plan JSON on H:\\SOSWebsite\\RedDirt (read-only ingest). County VAP for campus share is estimated until ACS loads.",
  };
}
