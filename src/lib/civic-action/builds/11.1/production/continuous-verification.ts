/**
 * CAE-11.1-W8 — Continuous verification schedules
 */
...
const DEFAULT_SCHEDULES: VerificationSchedule[] = [
  {
    ...
    checks: ["API health", "Initiative store integrity", "Event outbox depth", "Failed webhooks"],
  },
  {
    ...
    checks: ["Approval latency", "Owner-required backlog", "Overdue reviews", "Permission anomalies"],
  },
  {
    ...
    checks: ["Optimization acceptance rate", "Training gaps", "Template evolution", "Org health trends"],
  },
  {
  ...
  },
  {
    ...
    checks: ["Portfolio outcomes", "Institutional memory quality", "Statewide readiness", "Operator certification renewal"],
  },
];
