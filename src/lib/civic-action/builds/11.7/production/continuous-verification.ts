/**
 * CAE-11.7-W8 — Continuous verification schedules
 */
...
const DEFAULT_SCHEDULES: VerificationSchedule[] = [
  {
    ...
    checks: ["API health", "Communication store integrity", "Event outbox depth", "Failed webhooks"],
  },
  {
    ...
    checks: ["Lifecycle violations", "Orphan message detection", "Permission anomalies", "Overdue decisions"],
  },
  {
    ...
    checks: ["Optimization acceptance rate", "Lessons captured", "Template evolution", "Communication health trends"],
  },
  {
...
export function getCommunicationVerificationSchedules(): VerificationSchedule[] {
