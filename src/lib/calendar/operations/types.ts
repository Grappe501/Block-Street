...
export const ATTENTION_KEYS = [
  ...
  "no_staffing_plan",
  "staffing_below_minimum",
  "staffing_below_target",
  "missing_shift_lead",
  "shift_lead_training_missing",
  "volunteer_training_gap",
  "unreviewed_volunteer_interest",
  "unreviewed_critical_interest",
  ...
  "assignment_canceled",
  "replacement_needed",
  "critical_replacement_needed",
  "waitlist_available",
  "waitlist_empty",
  "training_condition_pending",
  "assignment_conflict",
  "volunteer_response_overdue",
  "overstaffed_shift",
  "invalid_shift_time",
  "unresolved_conflict",
