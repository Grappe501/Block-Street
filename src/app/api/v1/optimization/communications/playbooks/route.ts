...
export const GET = withApiGateway(
  async (ctx, request) =>
    withCommunicationApi(ctx, request, (apiCtx) => {
      ...
      return {
        playbooks: communicationOptimizationService.getPlaybooks(apiCtx.institution_id, initiativeId),
        advisory_only: true,
      };
    }),
  { permission: "civic_action.view", endpoint: "/api/v1/optimization/communications/playbooks" }
);
