...
export const GET = withApiGateway(
  async (ctx, request) =>
    withFederationApi(ctx, request, () => {
      ...
      return { agreements: operationsApplicationService.listFederationAgreements(federationId) };
    }),
  { permission: "federation.view", endpoint: "/api/v1/federations/{id}/agreements" }
);
