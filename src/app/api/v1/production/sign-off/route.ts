...
import type { ExecutiveSignOffRecord } from "@/lib/civic-action/builds/11.1/production/contracts";
...
export const POST = withApiGateway(
  async (ctx, request) =>
    withInitiativeApi(
      ...
      async (apiCtx) => {
        ...
        return {
          sign_off: institutionalProductionService.recordSignOff({
  ...
  { permission: "civic_action.view", endpoint: "/api/v1/production/sign-off" }
);
