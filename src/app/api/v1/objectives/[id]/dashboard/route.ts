...
import { queryObjectiveDashboard } from "@/lib/civic-action/builds/11.2/api";
...
export const GET = withApiGateway(
  async (ctx, request) => {
    ...
    return withObjectiveApi(ctx, request, (apiCtx) => queryObjectiveDashboard(initiativeId, id, apiCtx));
  },
  { permission: "civic_action.view", endpoint: "/api/v1/objectives/[id]/dashboard" }
);
