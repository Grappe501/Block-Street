...
import { getCommunityCapacity } from "@/lib/community-health/engine";
...
export const GET = withApiGateway(
  async (ctx, request) => {
    ...
    return apiSuccess(getCommunityCapacity(communityId, institutionId), {
      request_id: ctx.request_id,
      correlation_id: ctx.correlation_id,
    });
  },
  { permission: "community_health.view", endpoint: "/api/v1/community-health/capacity" }
);
