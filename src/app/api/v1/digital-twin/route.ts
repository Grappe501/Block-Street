...
export const GET = withApiGateway(
  async (ctx, request) =>
    withEvolutionApi(ctx, request, (apiCtx) => ({
      drift: operationsApplicationService.detectOpsDrift(apiCtx.institution_id),
    })),
  { permission: "evolution.view", endpoint: "/api/v1/digital-twin" }
);
...
export const POST = withApiGateway(
  ...
  { permission: "evolution.manage", endpoint: "/api/v1/digital-twin" }
);
