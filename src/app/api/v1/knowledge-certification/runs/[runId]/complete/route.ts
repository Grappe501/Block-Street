...
export const POST = withApiGateway(
  async (ctx, request) =>
    withKnowledgeApi(ctx, request, () => {
      ...
      return {
        run: knowledgeProductionService.completeCertificationRun(runId),
        event: "certification.run_completed",
      };
    }),
  { permission: "civic_action.manage", endpoint: "/api/v1/knowledge-certification/runs/{runId}/complete" }
);
