...
export const GET = withApiGateway(
  async (ctx, request) =>
    withOpsIntelligenceApi(ctx, request, (apiCtx) => ({
      scenarios: operationsApplicationService.listInstitutionalScenarios(apiCtx.institution_id),
    })),
  { permission: "intelligence.view", endpoint: "/api/v1/intelligence/scenarios" }
);
