...
export const GET = withApiGateway(
  async (ctx, request) =>
    withObjectiveApi(ctx, request, (apiCtx) => {
      ...
      return {
        forecasts: objectiveIntelligenceService.getForecasts(intelCtx),
        timeline_collisions: objectiveIntelligenceService.getTimelineCollisions(intelCtx),
        advisory_only: true,
      };
    }),
  { permission: "civic_action.view", endpoint: "/api/v1/intelligence/objectives/forecast" }
);
