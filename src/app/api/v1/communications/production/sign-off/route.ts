...
import type { ExecutiveSignOffRecord } from "@/lib/civic-action/builds/11.7/production/contracts";
...
export const POST = withApiGateway(
  async (ctx, request) =>
    withCommunicationApi(
      ...
      async (apiCtx) => {
        ...
        return {
          sign_off: communicationProductionService.recordSignOff({
  ...
  { permission: "civic_action.view", endpoint: "/api/v1/communications/production/sign-off" }
);
