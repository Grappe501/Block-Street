...
export default async function Page({ params }: { params: Promise<{ collegeSlug: string }> }) {
  ...
  return (
    <CollegeChrome slug={college.slug} name={college.name} title="Recruit volunteers">
      <p className="text-sm text-slate-700">Invite classmates and friends into the VR team using campus recruitment scripts.</p>
