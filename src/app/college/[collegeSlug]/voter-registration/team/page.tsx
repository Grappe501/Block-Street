...
export default async function Page({ params }: { params: Promise<{ collegeSlug: string }> }) {
  ...
  return (
    <CollegeChrome slug={college.slug} name={college.name} title="Registration team">
      <p className="text-sm text-slate-700">Open Voter Registration Team roles and express interest. Not appointment.</p>
