...
export default async function Page({ params }: { params: Promise<{ collegeSlug: string }> }) {
  ...
  return (
    <CollegeChrome slug={college.slug} name={college.name} title="Student organizations">
      <p className="text-sm text-slate-700">Invite org leaders to explore campus teams and the networking event.</p>
