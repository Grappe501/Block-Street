...
export default async function Page({ params }: { params: Promise<{ collegeSlug: string }> }) {
  ...
  return (
    <CollegeChrome slug={college.slug} name={college.name} title="Friends & classmates">
      <p className="text-sm text-slate-700">Start a personal conversation. Invite them to Orientation or this College Community. Ask what interests them.</p>
