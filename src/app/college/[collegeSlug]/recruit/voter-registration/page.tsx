...
export default async function Page({ params }: { params: Promise<{ collegeSlug: string }> }) {
  ...
  return (
    <CollegeChrome slug={college.slug} name={college.name} title="VR volunteer invitation">
      <p className="text-sm text-slate-700">Invite help for first-week tables after readiness gates allow.</p>
