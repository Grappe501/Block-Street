...
export default async function Page({ params }: { params: Promise<{ collegeSlug: string }> }) {
  ...
  return (
    <CollegeChrome slug={college.slug} name={college.name} title="Prepare invitation">
      <p className="text-sm text-slate-700">Soft-beta invitation · Invitation prepared · Invite link available · Binding not yet certified.</p>
