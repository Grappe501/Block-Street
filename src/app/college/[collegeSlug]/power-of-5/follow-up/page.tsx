...
export default async function Page({ params }: { params: Promise<{ collegeSlug: string }> }) {
  ...
  return (
    <CollegeChrome slug={college.slug} name={college.name} title="Follow up">
      <p className="text-sm text-slate-700">After interest, connect them to Orientation, a team, the networking event, or a VR shift.</p>
