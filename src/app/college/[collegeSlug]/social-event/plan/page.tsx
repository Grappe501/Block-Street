...
export default async function Page({ params }: { params: Promise<{ collegeSlug: string }> }) {
  ...
  return (
    <CollegeChrome slug={college.slug} name={college.name} title="Event planning board">
      <p className="text-sm text-slate-700">Concept, dates, venues, hospitality, activities, food, promotion, invitations, team showcase, signup, follow-up, readiness.</p>
