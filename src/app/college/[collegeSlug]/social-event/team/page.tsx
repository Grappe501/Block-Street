...
export default async function Page({ params }: { params: Promise<{ collegeSlug: string }> }) {
  ...
  return (
    <CollegeChrome slug={college.slug} name={college.name} title="Planning team">
      <p className="text-sm text-slate-700">Social and Events Lead and volunteers. Interest ≠ appointment.</p>
