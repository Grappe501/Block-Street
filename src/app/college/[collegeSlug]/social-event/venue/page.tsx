...
export default async function Page({ params }: { params: Promise<{ collegeSlug: string }> }) {
  ...
  return (
    <CollegeChrome slug={college.slug} name={college.name} title="Venue options">
      <p className="text-sm text-slate-700">Identify three possible locations. Permissions remain verification gates.</p>
