...
import type { LaunchControlView, ProductionCertificationView, ReadinessCheck } from "@/lib/civic-action/builds/11.2/production/contracts";
...
export function ObjectiveLaunchControlCenter({
  launch,
  levels,
  onSignOff,
}: {
