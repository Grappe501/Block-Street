...
export function RecommendationCard({
  ...
  recommendation: InitiativeRecommendation;
  ...
  return (
    <article className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
      ...
      {recommendation.uncertainty_notes.length > 0 && (
        <p className="mt-2 text-xs text-slate-500">Uncertainty: {recommendation.uncertainty_notes.join(" ")}</p>
      )}
