...
import type { LaunchControlView, ProductionCertificationView, ReadinessCheck } from "@/lib/civic-action/builds/11.7/production/contracts";
...
export function CommunicationLaunchControlCenter({
  launch,
  levels,
  onSignOff,
}: {
